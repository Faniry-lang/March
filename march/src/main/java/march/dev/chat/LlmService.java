...
public class LlmService {
    ...
    public LlmService(ToolRegistry toolRegistry, MethodRunner methodRunner, ObjectMapper objectMapper,
            String geminiApiKey) {
    ...
    public String chatWithGemini(String text) {
        String responseText = "";
        try {
            GenerateContentResponse response = geminiClient.models.generateContent("gemini-2.5-flash", text, null);
    ...
    public String chat(String userMessage) throws Exception {
        ...
        while (true) {
            ...
            try {
                String llmResponseString = this.chatWithGemini(history);
